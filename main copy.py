...
def main():
    ...
    class Datasets(torch.utils.data.Dataset):
        ...
        def __getitem__(self, index):
            ...
            t_class_id = torch.tensor([class_id], dtype=torch.float32)
            return {'img': t_img, 'class_id': t_class_id}
        

    train_dogs = '/home/kafla/Projects/cat or dogs/archive/training_set/training_set/dogs/'
    train_cats = '/home/kafla/Projects/cat or dogs/archive/training_set/training_set/cats'
    test_dogs = '/home/kafla/Projects/cat or dogs/archive/test_set/test_set/dogs/'
    test_cats = '/home/kafla/Projects/cat or dogs/archive/test_set/test_set/cats/'
    ...
    class VGG16(nn.Module):
        def __init__(self, out_nc=1):
            ...
            self.fl1 = nn.Linear(7*7*512, 4096)
            self.fl2 = nn.Linear(4096, 4096)
            self.fl3 = nn.Linear(4096, out_nc)
